...
// 스크린샷 위주, 과정 위주
### 템플릿 설정
**템플릿(Template)** 페이지에서 추가할 카드에 대한 정보를 설정하실 수 있습니다.
- 템플릿에서 대상 웹페이지, 카드의 구성 코드, 탐색 대상 정보, 기타 메타 데이터 등을 설정할 수 있습니다.
...
스캔된 카드는 선택하여 Anki에 추가하거나, 수정할 수 있습니다.
