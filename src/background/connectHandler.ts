...
export const connectHandler = (port: chrome.runtime.Port) => {
  ...
  switch (port.name) {
    case PORT_NAMES.ENTER_INSPECTION_MODE_FROM_PANEL:
      ...
      break;
    case PORT_NAMES.READY_INSPECTION_MODE_FROM_CONTENT:
