import useTemplates from "@/panel/stores/useTemplates";
...
const emptyTemplate: Template = {
    ...
    tags: [],
    fields: [
      {name: "Front", html: "<h2>{{front}}</h2>", items: [{name: "front", content: "h1", dataType: TEMPLATE_ITEM_DATA_TYPES.TEXT,isOptional: false}], priority:1 },
      {name:"Back", html: "<p>{{back}}</p>", items: [{name: "back", content: "p", dataType: TEMPLATE_ITEM_DATA_TYPES.TEXT,isOptional: false}], priority:2 },
    ]
};
